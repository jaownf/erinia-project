    ...
    <footer className={footerClass}>
      <div className="footer-content">
        <ul className="pages-ul">
          ...
          <a href="#"><li className="pages-li">TUTORIAL</li></a>
          <a href="/bestiario"><li className="pages-li">BESTIÁRIO</li></a>
          <a href="/login"><li className="pages-li">CADASTRO</li></a>
          <a href="/historia"><li className="pages-li">HISTÓRIA</li></a>
        </ul>
        <ul>
          <div className="social"><a href="https://chat.whatsapp.com/KCjoT2iBuQgIKJvSGbrdSa"><img src={whatsapp} alt="whatsapp" /></a></div>
